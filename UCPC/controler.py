...
class Controler():
    ...
    def control(self, state):
        ...
        self.kp_a = 1/self.constante_tuning_angular*self.kp_a
        self.kd_a = 1/self.constante_tuning_angular*self.kd_a
        self.ki_a = 1/self.constante_tuning_angular*self.ki_a
