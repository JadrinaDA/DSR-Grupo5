...
class Controler():
    ...
    def control(self, state):
        ...
        self.kp_l = 1/self.constante_tuning_lineal*self.kp_l
        self.kd_l = 1/self.constante_tuning_lineal*self.kd_l
        self.ki_l = 1/self.constante_tuning_lineal*self.ki_l
